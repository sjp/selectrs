test_that("selection works correctly on a shakespearean document", {
    ...
    # Data borrowed from http://mootools.net/slickspeed/; a representative
    # slice spanning type/class/id/attribute/combinator/pseudo-class
    # selectors at scale. Full translation correctness is the css-to-xpath
    # crate's concern.
