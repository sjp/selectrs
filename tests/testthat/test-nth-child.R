# Document-querying blocks ported from selectr's tests/testthat/test-nth-child.R
...
test_that(":nth-child() works correctly with XML documents", {
    ...
    # First child
    expect_equal(get_ids("li:nth-child(1)"), c("li1", "li6"))

    # Second child
    expect_equal(get_ids("li:nth-child(2)"), c("li2", "li7"))

    # Third child
    expect_equal(get_ids("li:nth-child(3)"), c("li3", "li8"))

    # Odd children (1, 3, 5)
    expect_equal(get_ids("li:nth-child(odd)"), c("li1", "li3", "li5", "li6", "li8"))

    # Even children (2, 4)
    expect_equal(get_ids("li:nth-child(even)"), c("li2", "li4", "li7"))

    # Every 2nd child starting from 2 (same as even)
    expect_equal(get_ids("li:nth-child(2n)"), c("li2", "li4", "li7"))

    # Every 2nd child starting from 1 (same as odd)
    expect_equal(get_ids("li:nth-child(2n+1)"), c("li1", "li3", "li5", "li6", "li8"))

    # Every 3rd child starting from 1 (1, 4)
    expect_equal(get_ids("li:nth-child(3n+1)"), c("li1", "li4", "li6"))

    # Every 3rd child starting from 2 (2, 5)
    expect_equal(get_ids("li:nth-child(3n+2)"), c("li2", "li5", "li7"))

    # First 3 children
    expect_equal(get_ids("li:nth-child(-n+3)"), c("li1", "li2", "li3", "li6", "li7", "li8"))
...
test_that(":nth-last-child() works correctly with XML documents", {
    ...
    # Last child
    expect_equal(get_ids("li:nth-last-child(1)"), c("li5", "li8"))

    # Second from last
    expect_equal(get_ids("li:nth-last-child(2)"), c("li4", "li7"))

    # Third from last
    expect_equal(get_ids("li:nth-last-child(3)"), c("li3", "li6"))

    # Odd from end (last=1, 3rd-last=3, 5th-last=5)
    expect_equal(get_ids("li:nth-last-child(odd)"), c("li1", "li3", "li5", "li6", "li8"))

    # Even from end (2nd-last=2, 4th-last=4)
    expect_equal(get_ids("li:nth-last-child(even)"), c("li2", "li4", "li7"))

    # Last 2 children
    expect_equal(get_ids("li:nth-last-child(-n+2)"), c("li4", "li5", "li7", "li8"))

    # Last 3 children
    expect_equal(get_ids("li:nth-last-child(-n+3)"), c("li3", "li4", "li5", "li6", "li7", "li8"))
})
...
test_that(":nth-last-child() works correctly with xml2 documents", {
    ...
    # Last child
    expect_equal(get_ids("li:nth-last-child(1)"), "li5")

    # Second from last
    expect_equal(get_ids("li:nth-last-child(2)"), "li4")

    # Last 2 children
    expect_equal(get_ids("li:nth-last-child(-n+2)"), c("li4", "li5"))
})
...
test_that(":nth-child() and :nth-last-child() can be combined", {
    ...
    expect_equal(get_ids("li:nth-child(2):nth-last-child(4)"), "li2")

    # Middle element (3rd child AND 3rd from last)
    expect_equal(get_ids("li:nth-child(3):nth-last-child(3)"), "li3")

    # First child that's also last child (only child)
    # This won't match in our test case since we have 5 items
    expect_equal(length(querySelectorAll(doc, "li:nth-child(1):nth-last-child(1)")), 0)
})
...
test_that(":nth-child() edge cases", {
    ...
    expect_equal(length(querySelectorAll(doc1, "li:nth-child(1)")), 0)
    ...
    expect_equal(get_ids("p:nth-child(1)"), "p1")

    # Second child (div element that is second child)
    expect_equal(get_ids("div:nth-child(2)"), "d1")

    # All p elements that are odd children
    expect_equal(get_ids("p:nth-child(odd)"), c("p1", "p2"))
})
...
test_that(":nth-child() with different element types", {
    ...
    expect_equal(get_ids("p:nth-child(2)"), "p1")

    # p:nth-child(3) - p that is 3rd child (p2)
    expect_equal(get_ids("p:nth-child(3)"), "p2")

    # p:nth-child(1) - p that is first child (none)
    expect_equal(length(querySelectorAll(doc, "p:nth-child(1)")), 0)

    # span:nth-child(4) - span that is 4th child (s1)
    expect_equal(get_ids("span:nth-child(4)"), "s1")
})
...
test_that(":nth-child() with complex selectors", {
    ...
    expect_equal(get_ids(".item:nth-child(1)"), "li1")

    # Multiple classes with :nth-child
    expect_equal(get_ids(".item.active:nth-child(2)"), "li2")

    # Descendant combinator with :nth-child
    expect_equal(get_ids(".menu li:nth-child(2)"), "li2")

    # Child combinator with :nth-child
    expect_equal(get_ids(".menu > li:nth-child(3)"), "li3")
})
...
test_that(":nth-child() early-exit condition 1: a=1, b-1<=0 (matches all)", {
    ...
    expect_equal(get_ids("li:nth-child(n)"), c("li1", "li2", "li3", "li4"))

    # :nth-child(1n+0) -> a=1, b=0, b-1=-1<=0 -> matches all
    expect_equal(get_ids("li:nth-child(1n+0)"), c("li1", "li2", "li3", "li4"))

    # :nth-child(n+1) -> a=1, b=1, b-1=0<=0 -> matches all
    expect_equal(get_ids("li:nth-child(n+1)"), c("li1", "li2", "li3", "li4"))

    # :nth-child(1n+1) -> a=1, b=1, b-1=0<=0 -> matches all
    expect_equal(get_ids("li:nth-child(1n+1)"), c("li1", "li2", "li3", "li4"))

    # :nth-child(n-1) -> a=1, b=-1, b-1=-2<=0 -> matches all
    expect_equal(get_ids("li:nth-child(n-1)"), c("li1", "li2", "li3", "li4"))

    # :nth-child(n-5) -> a=1, b=-5, b-1=-6<=0 -> matches all
    expect_equal(get_ids("li:nth-child(n-5)"), c("li1", "li2", "li3", "li4"))
})
...
test_that(":nth-child() early-exit condition 1 with selector list", {
    ...
    expect_equal(get_ids("li:nth-child(n of .item)"), c("li1", "li2", "li4"))

    # :nth-child(1n+0 of .item) -> same as above
    expect_equal(get_ids("li:nth-child(1n+0 of .item)"), c("li1", "li2", "li4"))

    # :nth-child(n+1 of .item) -> a=1, b=1 -> filtered by .item
    expect_equal(get_ids("li:nth-child(n+1 of .item)"), c("li1", "li2", "li4"))
})
...
test_that(":nth-last-child() early-exit condition 1: a=1, b-1<=0", {
    ...
    expect_equal(get_ids("li:nth-last-child(n)"), c("li1", "li2", "li3"))

    # :nth-last-child(n+1) -> a=1, b=1, b-1=0<=0 -> matches all
    expect_equal(get_ids("li:nth-last-child(n+1)"), c("li1", "li2", "li3"))

    # :nth-last-child(n of .special) -> filtered by .special
    expect_equal(get_ids("li:nth-last-child(n of .special)"), "li2")
})
...
test_that(":nth-child() early-exit condition 2: a<0, b-1<0 (matches none)", {
    ...
    expect_equal(length(querySelectorAll(doc, "li:nth-child(-n-1)")), 0)

    # :nth-child(-2n-1) -> a=-2, b=-1, b-1=-2<0 -> impossible, matches none
    expect_equal(length(querySelectorAll(doc, "li:nth-child(-2n-1)")), 0)

    # :nth-child(-3n-5) -> a=-3, b=-5, b-1=-6<0 -> impossible, matches none
    expect_equal(length(querySelectorAll(doc, "li:nth-child(-3n-5)")), 0)
...
test_that(":nth-child() early-exit condition 2 with selector list", {
    ...
    expect_equal(length(querySelectorAll(doc, "li:nth-child(-n of .item)")), 0)

    # :nth-child(-2n-1 of .item) -> a=-2, b=-1 -> impossible
    expect_equal(length(querySelectorAll(doc, "li:nth-child(-2n-1 of .item)")), 0)
...
test_that(":nth-last-child() early-exit condition 2: a<0, b-1<0", {
    ...
    expect_equal(length(querySelectorAll(doc, "li:nth-last-child(-n)")), 0)

    # :nth-last-child(-n-1) -> a=-1, b=-1, b-1=-2<0 -> impossible
    expect_equal(length(querySelectorAll(doc, "li:nth-last-child(-n-1)")), 0)

    # :nth-last-child(-n of .special) -> impossible even with selector
    expect_equal(length(querySelectorAll(doc, "li:nth-last-child(-n of .special)")), 0)
})
...
test_that(":nth-child() boundary between early-exit conditions", {
    ...
    expect_equal(length(querySelectorAll(doc, "li:nth-child(-n+0)")), 0)

    # :nth-child(-n+1) -> a=-1, b=1, b-1=0 -> NOT early-exit (b-1 not <0)
    # This should match first child only
    expect_equal(get_ids("li:nth-child(-n+1)"), "li1")

    # :nth-child(-n+2) -> a=-1, b=2, b-1=1 -> matches first 2
    expect_equal(get_ids("li:nth-child(-n+2)"), c("li1", "li2"))

    # :nth-child(-2n+2) -> a=-2, b=2, b-1=1 -> matches 2nd child
    expect_equal(get_ids("li:nth-child(-2n+2)"), "li2")

    # :nth-child(-2n+0) -> a=-2, b=0, b-1=-1<0 -> early-exit condition 2
    expect_equal(length(querySelectorAll(doc, "li:nth-child(-2n+0)")), 0)
})
